...
const routes: Routes = [
  ...
  { path: 'helps/complete/:id', component: HelpsCompleteComponent, data: {title: 'Completa aiuto'}, canActivate: [AuthGuard] },
  ...
  { path: 'upload', component: TestUploadComponent, data: {title: 'Upload'}, canActivate: [AuthGuard] },
